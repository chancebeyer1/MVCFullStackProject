...
<html lang="en">
    ...
    <body>
        <h1>NovaBACKUP Redemption / Order Form For Buffalo TeraStation Customers</h1>
        <h2 class="center">Option 1</h2>
        <h3>Get FREE Standard Package Items</h3>
        <div class="container">
            <h2>NovaBACKUP® Server - No Support</h2>
            <p>Backup software for Windows OS Servers – <em>No Support/License Only</em></p>
            <h2>NovaBACKUP® Workstation Buffalo Edition - No Support</h2>
            <p>Backup software for 10 Windows PCs/Laptops – <em>No Support/License Only</em></p>
            <div class="align">
                <a href = "https://store.novastor.com/243/uurl-5vhtvozpgz?cart=203061&quantity_203061=1&currencies=USD&cookie=false&x-serial=<?= $serial ?>" class="button">
                    Select  
                </a>
            </div>
        </div>
                    ...
                    <form id="novaProducts" action="./serialProduct" method="GET">
                        ...
                        <div class="totals">
                            ...
                            <div class="totals-item">
                                ...
                                <div class="totals-value discount" id="cart-shipping">-$150</div>
                            </div>
